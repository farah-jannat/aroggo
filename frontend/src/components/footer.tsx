...
const Footer = () => {
  ...
  const [selectAddressModal, setSelectAddressModal] = useState(true);
  ...
  return (
    <>
      <footer className="bg-[#0b1218] text-white py-12 px-6 md:px-16 font-sans relative">
        ...
        {/* <div className="hidden  fixed top-34 right-0 sm:flex flex-col items-end gap-3 zz-50 z-57">
          <CartDrawer setSelectAddressModal={setSelectAddressModal} />
        </div> */}
      </footer>
